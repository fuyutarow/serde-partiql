//! A map of String to serde_partiql::Value.
//!
//! By default the map is backed by a [`BTreeMap`]. Enable the `preserve_order`
//! feature of serde_partiql to use [`IndexMap`] instead.
//!
...
/// #
/// # let mut map = serde_partiql::Map::new();
/// # map.insert("key".to_owned(), serde_partiql::Value::Null);
/// #
/// map["key"] = json!("value");
/// ```
...
/// An iterator over a serde_partiql::Map's entries.
pub struct Iter<'a> {
    iter: IterImpl<'a>,
}
...
/// A mutable iterator over a serde_partiql::Map's entries.
...
/// An owning iterator over a serde_partiql::Map's entries.
pub struct IntoIter {
    iter: IntoIterImpl,
}
...
/// An iterator over a serde_partiql::Map's keys.
pub struct Keys<'a> {
    iter: KeysImpl<'a>,
}
...
/// An iterator over a serde_partiql::Map's values.
pub struct Values<'a> {
    iter: ValuesImpl<'a>,
}
...
/// A mutable iterator over a serde_partiql::Map's values.
