...
//! # No-std support
//!
//! As long as there is a memory allocator, it is possible to use serde_partiql
...
#![doc(html_root_url = "https://docs.rs/serde_partiql/1.0.64")]
